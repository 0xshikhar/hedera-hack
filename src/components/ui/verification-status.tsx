...
import { useVerifierContract, VerificationInfo } from "@/hooks/blockchain/useVerifierContract";
...
export function VerificationStatus({ datasetId, onVerifyClick }: VerificationStatusProps) {
  ...
  const { getDatasetVerificationInfo } = useVerifierContract();
  ...
  }, [datasetId, getDatasetVerificationInfo]);
